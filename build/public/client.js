  ...
  ***************************************************************************** */
  ...
  function createPropDecorator(propertyInitiallyEnumerable, propertyCreator) {
      return function decoratorFactory() {
          ...
          // as the instance to apply the deorator to equals the target
              ...
              if (false !== "production" && !quacksLikeADecorator(arguments)) fail$1("This function is a decorator, but it wasn't invoked like a decorator");
  ...
  var ComputedValue = /** @class */function () {
      ...
      ComputedValue.prototype.set = function (value) {
          ...
          } else invariant(false, false !== "production" && "[ComputedValue '" + this.name + "'] It is not possible to assign a new value to a computed value.");
      };
  ...
  var ObservableObjectAdministration = /** @class */function () {
      ...
      ObservableObjectAdministration.prototype.observe = function (callback, fireImmediately) {
          false !== "production" && invariant(fireImmediately !== true, "`observe` doesn't support the fire immediately property for observable objects.");
  ...
  function asObservableObject(target, name, defaultEnhancer) {
      ...
      var adm = target.$mobx;
      if (adm) return adm;
      false !== "production" && invariant(Object.isExtensible(target), "Cannot make the designated object observable; it is not extensible");
  ...
  function createDecoratorForEnhancer(enhancer) {
      ...
      typeof process !== "undefined" && process.env && false !== "production" ? function observableDecorator() {
  ...
  function _isObservable(value, property) {
      ...
      if (property !== undefined) {
          if (false !== "production" && (isObservableMap(value) || isObservableArray(value))) return fail$1("isObservable(object, propertyName) is not supported for arrays and maps. Use map.has or array.length instead.");
  ...
  function isObservable(value) {
      if (arguments.length !== 1) fail$1(false !== "production" && "isObservable expects only 1 argument. Use isObservableProp to inspect the observability of a property");
  ...
  function isComputed(value) {
      if (arguments.length > 1) return fail$1(false !== "production" && "isComputed expects only 1 argument. Use isObservableProp to inspect the observability of a property");
  ...
  var computedDecorator = createPropDecorator(false, function (instance, propertyName, descriptor, decoratorTarget, decoratorArgs) {
      ...
      defineComputedProperty(instance, propertyName, __assign({}, options, { get: get$$1, set: set$$1 }));
  });
  ...
  function extendObservable(target, properties, decorators, options) {
      ...
      try {
          for (var key in properties) {
              ...
              if (false !== "production" && typeof decorator !== "function") return fail$1("Not a valid decorator for '" + key + "', got: " + decorator);
  ...
  function createObservable(v, arg2, arg3) {
      ...
      fail$1(false !== "production" && "The provided value could not be converted into an observable. If you want just create an observable reference to the object use 'observable.box(value)'");
  }
  ...
  function shallowEnhancer(v, _, name) {
      ...
      return fail$1(false !== "production" && "The shallow modifier / decorator can only used in combination with arrays, objects and maps");
  }
  ...
  function refStructEnhancer(v, oldValue, name) {
      if (false !== "production" && isObservable(v)) throw "observable.struct should not be used with observable values";
  ...
  var ObservableMap = /** @class */function () {
      ...
      ObservableMap.prototype.observe = function (listener, fireImmediately) {
          false !== "production" && invariant(fireImmediately !== true, "`observe` doesn't support fireImmediately=true in combination with maps.");
          return registerListener(this, listener);
      };
  ...
  function getAtom(thing, property) {
      if ((typeof thing === "undefined" ? "undefined" : _typeof(thing)) === "object" && thing !== null) {
          if (isObservableArray(thing)) {
              if (property !== undefined) fail$1(false !== "production" && "It is not possible to get index atoms from arrays");
          ...
          if (isObservableMap(thing)) {
              ...
              if (!observable) fail$1(false !== "production" && "the entry '" + property + "' does not exist in the observable map '" + getDebugName(thing) + "'");
              return observable;
          }
          // Initializers run lazily when transpiling to babel, so make sure they are run...
          initializeInstance(thing);
          ...
          if (isObservableObject(thing)) {
              if (!property) return fail$1(false !== "production" && "please specify a property");
              var observable = thing.$mobx.values[property];
              if (!observable) fail$1(false !== "production" && "no observable property '" + property + "' found on the observable object '" + getDebugName(thing) + "'");
              return observable;
          }
      ...
      return fail$1(false !== "production" && "Cannot obtain atom from " + thing);
  }
  function getAdministration(thing, property) {
      ...
      fail$1(false !== "production" && "Cannot obtain administration from " + thing);
  }
  ...
  function assertPropertyConfigurable(object, prop) {
      if (false !== "production" && !isPropertyConfigurable(object, prop)) fail$1("Cannot make property '" + prop + "' observable, it is not configurable and writable in the target object");
  }
      ...
      if (!global_1.__mobxInstanceCount) {
          ...
          setTimeout(function () {
              if (!runInIsolationCalled) {
                  fail$1(false !== "production" && "There are multiple mobx instances active. This might lead to unexpected results. See https://github.com/mobxjs/mobx/issues/1082 for details.");
              }
          }, 1);
      }
  }
  ...
  function trace() {
      ...
      if (!derivation) {
          return fail$1(false !== "production" && "'trace(break?)' can only be used inside a tracked computed value or a Reaction. Consider passing in the computed value or reaction explicitly");
      }
  ...
  function keys(obj) {
      ...
      return fail$1(false !== "production" && "'keys()' can only be used on observable objects and maps");
  }
  ...
  (function () {
      ...
      if (testCodeMinification.name !== "testCodeMinification" && false !== "production") {
          console.warn("[mobx] you are running a minified build, but 'false' was not set to 'production' in your bundler. This results in an unnecessarily large and slow bundle");
      }
  })();
  ...
  if (false !== "production" && typeof module !== "undefined" && typeof module.exports !== "undefined") {
  ...
  var store = observable({
    ...
    subscribe: function subscribe(field) {
      ...
      extendObservable(store, defineProperty({}, field, []));
      store.maps[field] = [];
      return fetch('/db/' + field).then(function (res) {
        return res.json();
      }).then(function (rows) {
        transaction(function () {
          for (var id in rows) {
  ...
  function mirror(field) {
    return function (event) {
      if (event.type === 'splice') {
        ...
        store.maps[field].splice(event.index, event.removedCount).forEach(remove$1(field));
      } else {
        update(field, event.index);
      }
    };
  }
  function add(field, main_index) {
    return function (value, i) {
      var is_json = value === Object(value);
      fetch('/db/' + field, {
        headers: new Headers({
  ...
  function update(field, i) {
    var value = toJS(store[field][i]);
    var is_json = value === Object(value);
